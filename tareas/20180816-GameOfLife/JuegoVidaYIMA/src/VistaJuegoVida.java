...
import Vistas.LienzoImportarMatriz;
...
{    
    ...
    private LienzoImportarMatriz vistaPrevia;
    ...
    public void configuracionDeObjetosVisuales()
    {
        try
        {
            ...
            vistaPrevia         = new LienzoImportarMatriz(); //Inicia el lienzo de vista previa cargada por el usuario
            mallaPrincipal      = new Lienzo(_configuracion,vistaPrevia); //Se crea el objeto lienzo (donde se dibujaran los elementos)
            ...
            add(vistaPrevia, BorderLayout.EAST);
