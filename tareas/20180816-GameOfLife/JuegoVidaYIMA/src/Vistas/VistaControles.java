...
public class VistaControles extends JPanel implements ActionListener, ChangeListener  
{
    ...
    {        
      ...
      else if(e.getSource() == patron)
      {
          receptor.habilitarPatron(new ClickEvent(this,""));
      }
    }
}
