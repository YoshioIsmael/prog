...
public class Lienzo extends JPanel implements MouseListener, ClickEventListener, TimeEventListener
{
    ...
    private boolean verPatron;
    private SubprocesoActualizador hilo;
    private LienzoImportarMatriz vistaComparacion;
    
    //Constructor de la clase
    public Lienzo(Configuracion _configuracion, LienzoImportarMatriz vistaComparacion)
    {
        ...
        this.vistaComparacion   = vistaComparacion;
        verPatron               = false;
        ...
        vistaComparacion.inicializarComponentes(_configuracion.alto);
    ...
    public void aplicarConfiguracionZoom(int valorNuevo)
    {
        ...
        vistaComparacion.actualizar(valorNuevo);
    }
    ...
    {  
        ...
        if(verPatron)
        {
            vistaComparacion.repintarArea(calculador.obtenerComparacion(puntos));
        }
    }
    ...
    public void importarArchivo(ClickEvent e)
    {
        ...
        vistaComparacion.actualizar(matrizUbicacion.length);
    ...
    @Override
    public void habilitarPatron(ClickEvent e)
    {
        verPatron = !verPatron;
    }
}
